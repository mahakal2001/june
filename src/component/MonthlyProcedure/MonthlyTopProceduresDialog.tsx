...
import { MonthlyExportProcedurePDF } from "@/lib/MonthlyExportProcedure/MonthlyExportProcedurePDF";
import {
  ExportMonthlyProcedureExcel,
} from "@/lib/MonthlyExportProcedure/MonthlyExportProcedureExcel";
import {
  ExportMonthlyProcedureWhatsapp,
} from "@/lib/MonthlyExportProcedure/MonthlyExportProcedureWhatsapp";
import {
  MonthlyExportProcedurePrint,
} from "@/lib/MonthlyExportProcedure/MonthlyExportProcedurePrint";

import RevenueEmptyState from "@/component/RevenueExceptions/RevenueEmptyState";

import './MonthlyTopProceduresDialog.css';
...
export default function MonthlyTopProceduresDialog({
  open,
  onOpenChange,
  data,
  monthLabel,
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className="MonthlyProcedureDialog-dialog
          w-[96vw]
          max-w-6xl
          overflow-hidden
          rounded-sm
      ...
      >
        ...
        <div
          className="MonthlyProceduredialogTables-section
            mx-5
            mt-4
            hidden
            overflow-hidden
        ...
        >
          ...
          {data.length === 0 ? (
            ...
            >
              ...
              <Table
                className="MonthlyProcedure-Table border rounded-sm"
              >
