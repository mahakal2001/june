...
import { WeeklyFinancialHighlightsData } from "./WeeklyFinancialHighlightsData";
...
export default function WeeklyFinancialHighlights() {
  ...
  return (
    WeeklyFinancialHighlightsData[
      selectedWeek
    ] ??
    WeeklyFinancialHighlightsData.current
  );
