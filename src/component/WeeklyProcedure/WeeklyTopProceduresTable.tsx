...
import { WeeklyTopProcedureData } from "./WeeklyTopProduresData";
import WeeklyTopProceduresDialog from "./WeeklyTopProceduresDialog";
...
export default function WeeklyTopProceduresTable() {
  ...
  const procedureData = useMemo(() => {
    ...
    return (
      WeeklyTopProcedureData[
        selectedWeek
      ] ??
      WeeklyTopProcedureData.current
    );
  ...
  return (
    ...
    <Card
      className="Weeklyprocedure-Card
        w-full
        overflow-hidden
        rounded-sm
        border
