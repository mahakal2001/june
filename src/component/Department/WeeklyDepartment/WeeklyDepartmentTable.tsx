...
import { WeeklyDepartmentData } from "./WeeklyDepartmentData";
import WeeklyDepartmentMISDialog from "./WeeklyDepartmentMISDialog";
...
export default function WeeklyDepartmentTable() {
  ...
  const departmentData = useMemo(() => {
    ...
    return (
      WeeklyDepartmentData[selectedWeek] ??
      WeeklyDepartmentData.current
    );
  ...
  return (
    ...
    >
      ...
      <WeeklyDepartmentMISDialog open={detailsOpen}
      onOpenChange={setDetailsOpen} data={departmentData}
      weekLabel={weekLabel} />
