...
import WeeklyDepartmentDetailbox from "./WeeklyDepartmentDetailbox/WeeklyDepartmentDetailbox";
import { ExportWeeklyMISDepartmentPDF } from "@/lib/ExportWeeklyMISDepartment/ExportWeeklyMISDepartmentPDF";
import { ExportWeeklyMISDepartmentExcel } from "@/lib/ExportWeeklyMISDepartment/ExportWeeklyMISDepartmentExcel";
import { ExportWeeklyMISWhatsappReport } from "@/lib/ExportWeeklyMISDepartment/ExportWeeklyMISWhatsappReport";
import { WeeklyMISDepartmentPrintReport } from "@/lib/ExportWeeklyMISDepartment/WeeklyMISDepartmentPrintReport";

import "./WeeklyDepartmentMisDialog.css";
...
export default function WeeklyDepartmentMISDialog({
  ...
  const printReport = () => {
  WeeklyMISDepartmentPrintReport(
    filteredDepartments,
    weekLabel,
    {
      hospitalName:
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <ExportMenu
                ...
                onExcel={() => 
                    ExportWeeklyMISDepartmentExcel({
      ...
      <WeeklyDepartmentDetailbox open={departmentDetailOpen}
