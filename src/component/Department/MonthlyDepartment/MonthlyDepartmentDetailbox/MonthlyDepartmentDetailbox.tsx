...
import './MonthlyDepartmentDetailbox.css';
...
export default function MonthlyDepartmentDetailbox({
  open,
  onOpenChange,
  department,
  monthLabel,
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className="MdetailDialog-content
          w-[95vw]
          max-w-5xl
          max-h-[90vh]
          overflow-y-auto
          ...
          <div>
            ...
            <div className="pt-4 pb-4 text-center">
              ...
              <p
                ...
                "
              >
                Monthly growth and collection efficiency
              </p>
