...
import { MonthlyRevenueLeakageSummaryData } from "./MonthlyRevenueLeakageSummaryData";
import MonthlyRevenueLeakageSummaryDialog from "./MonthlyRevenueLeakageSummaryDialog";
...
export default function MonthlyRevenueLeakageSummary({
  growth = 6.8,
  items,
}: Props) {
  ...
  const leakageData = useMemo(() => {
    return (
      MonthlyRevenueLeakageSummaryData[selectedMonth] ??
      []
    );
  }, [selectedMonth]);
  ...
  return (
    ...
    >
      ...
      <MonthlyRevenueLeakageSummaryDialog open={leakageDialogOpen}
       onOpenChange={setLeakageDialogOpen}
       items={leakageData.items}
       totalLeakage={leakageData.totalLeakage}
       growth={leakageData.growth} monthLabel={monthLabel} />
