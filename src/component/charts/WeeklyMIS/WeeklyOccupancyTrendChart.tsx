...
import { weeklyOccupancyData } from "./weeklyOccupancyData";

export default function WeeklyOccupancyTrendChart() {
  ...
  return weeklyOccupancyData.slice(-count);
  }, [range]);

  const rangeLabels: Record<string, string> = {
  "2": "Current vs Previous Week",
  "4": "Last 4 Weeks",
  "8": "Last 8 Weeks",
  "12": "Last 12 Weeks",
  };
        ...
        <div className="mt-5 flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="text-right">
            ...
            >
              ...
              {occupancyChange >= 0 ? "+" : ""}
              {occupancyChange}% vs previous week
          ...
          >
            ...
            >
              ...
              <Area
                ...
                stroke="#2563EB"
                strokeWidth={2.5}
                fill="url(#weeklyOccupancyGradient)"
                dot={{
                  r: 4,
                  fill: "#2563EB",
                  stroke: "#FFFFFF",
