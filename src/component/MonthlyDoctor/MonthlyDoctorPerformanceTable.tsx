...
import MonthlyDoctorPerformanceDialog from "./MonthlyDoctorPerformanceDialog";

import './MonthlyDoctorPerformanceTable.css';

import {
  MonthlyDoctorPerformanceData,
} from "./MonthlyDoctorPerformance";
...
export default function MonthlyDoctorPerformance() {
  ...
  const doctorData = useMemo(() => {
    ...
    return (
      ...
      MonthlyDoctorPerformanceData.current
    );
  ...
  return (
    ...
    >
      ...
      <MonthlyDoctorPerformanceDialog
