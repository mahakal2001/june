...
export interface MonthlyDoctorWhatsappData {
  id: number | string;
...
interface MonthlyDoctorWhatsappOptions {
  department?: string;
...
export function ExportMonthlyDoctorPerformanceWhatsapp(

  doctors: MonthlyDoctorWhatsappData[],

  monthLabel: string,

  options: MonthlyDoctorWhatsappOptions = {}
