...
export interface MonthlyDoctorPrintData {
...
export function MonthlyExportDoctorPerformacePrint(
  doctors: MonthlyDoctorPrintData[],
  monthLabel: string,
...
<title>
  Monthly Doctor Performance Report
</title>
  ...
  <div class="section-header">
    ...
    <div>
      ...
      <div class="section-subtitle">
        Monthly performance metrics by doctor
      </div>
