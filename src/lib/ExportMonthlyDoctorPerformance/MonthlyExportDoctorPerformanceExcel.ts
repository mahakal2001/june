...
export interface MonthlyDoctorExcelData {
  id: number | string;
...
export async function ExportMonthlyDoctorPerformanceExcel(
  data: MonthlyDoctorExcelData[],
  monthLabel: string,
  ...
  try {
    ...
    worksheet.headerFooter.oddFooter =
      `&L${
        options.hospitalName ||
        "Hospital Management System"
      }&CMonthly Doctor Performance MIS&RPage &P of &N`;
