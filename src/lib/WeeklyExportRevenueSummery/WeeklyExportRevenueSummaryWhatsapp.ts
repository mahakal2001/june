...
export interface WeeklyRevenueLeakageWhatsappData {
  id: number | string;
...
export function WeeklyExportRevenueSummaryWhatsapp(
  data: WeeklyRevenueLeakageWhatsappData[],
  totalLeakage: number,
  growth: number,
  weekLabel: string,
  ...
  try {
    ...
    message +=
      `• Report : Weekly Revenue Leakage MIS\n\n`;
    ...
    console.log(
      "Weekly Revenue Leakage WhatsApp report generated."
    );
    ...
    console.error(
      "Weekly Revenue Leakage WhatsApp export failed:",
      error
    );
