...
export function WeeklyExportProcedurePDF(
  procedures: WeeklyProcedureData[],
  weekLabel: string,
  filters: {
    procedure: string;
    growth: string;
  ...
  doc.text(
    `Weekly Procedure Performance Overview • ${weekLabel}`,
    margin,
    24
  );
  ...
  for (
    ...
    doc.text(
      "Hospital Management System • Procedure Performance Weekly MIS",
      margin,
      pageHeight - 6
    );
