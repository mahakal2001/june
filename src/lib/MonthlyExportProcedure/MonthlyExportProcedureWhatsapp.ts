...
export interface MonthlyProcedureWhatsappData {
  id: number | string;
...
interface MonthlyProcedureWhatsappOptions {
  procedure?: string;
...
export function ExportMonthlyProcedureWhatsapp(
  procedures: MonthlyProcedureWhatsappData[],
  monthLabel: string,
  options: MonthlyProcedureWhatsappOptions = {}
): void {
