...
export interface MonthlyProcedureExcelData {
  id: number | string;
...
export async function ExportMonthlyProcedureExcel(
  data: MonthlyProcedureExcelData[],
  monthLabel: string,
  options: ExportOptions = {}
) {
  try {
    console.log("Monthly Procedure Excel export started");
    ...
    worksheet.headerFooter.oddFooter =
      `&L${
        options.hospitalName ||
        "Hospital Management System"
      }&CMonthly Top Procedures MIS&RPage &P of &N`;
    ...
    console.log(
      "Monthly Procedure Excel export completed:",
      fileName
    );
    ...
    console.error(
      "Monthly Procedure Excel export failed:",
      error
    );
