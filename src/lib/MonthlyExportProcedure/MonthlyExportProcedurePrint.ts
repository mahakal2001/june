...
export interface MonthlyProcedurePrintData {
  id: number | string;
...
export function MonthlyExportProcedurePrint(
  procedures: MonthlyProcedurePrintData[],
  monthLabel: string,
  ...
  <div class="section-header">
    ...
    <div>
      ...
      <div class="section-subtitle">
        ...
        Monthly performance metrics by procedure
