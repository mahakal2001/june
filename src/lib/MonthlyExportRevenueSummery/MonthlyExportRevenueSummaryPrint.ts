...
export interface MonthlyRevenueLeakagePrintData {
...
export function MonthlyExportRevenueSummaryPrint(

  items: MonthlyRevenueLeakagePrintData[],
  ...
  <div class="section-header">
    ...
    <div>
      ...
      <div class="section-subtitle">
        ...
        Monthly revenue leakage by category
