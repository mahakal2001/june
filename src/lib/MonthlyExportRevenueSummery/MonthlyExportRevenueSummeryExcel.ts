...
export interface MonthlyRevenueLeakageExcelData {
  id: number | string;
...
export async function ExportMonthlyRevenueLeakageExcel(
  data: MonthlyRevenueLeakageExcelData[],
  totalLeakage: number,
  _growth: number,
  monthLabel: string,
  ...
  try {
    console.log(
      "Monthly Revenue Leakage Excel export started"
    );
    ...
    worksheet.headerFooter.oddFooter =
      `&L${
        options.hospitalName ||
        "Hospital Management System"
      }&CMonthly Revenue Leakage MIS&RPage &P of &N`;
    ...
    console.log(
      "Monthly Revenue Leakage Excel export completed:",
      fileName
    );
  } catch (error) {
    console.error(
      "Monthly Revenue Leakage Excel export failed:",
      error
    );
